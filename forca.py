...
def jogar_novamente():
    ...
    print("Quer jogar novamente? (1) Sim, (2) Nao")
...
def jogar():
    ...
    palavra = input("Insira a palavra que será usada: ")
    dica1 = input("Insira a primeira dica da palavra escolhida: ")
    dica2 = input("Insira a segunda dica da palvra escolhida: ")
    dica3 = input("Insira a ultima dica da palavra escolhida: ")
    os.system("cls")
    ...
    for i in arquivo.readlines():
        lista_palavra.append(i.split('_'))
